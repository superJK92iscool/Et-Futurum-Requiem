...
public class MixinBlockFence {
	...
	public boolean canConnectFenceTo(IBlockAccess p_149826_1_, int p_149826_2_, int p_149826_3_, int p_149826_4_)
	{
		...
		return !(block instanceof BlockFence && block.getMaterial() == ((BlockFence)(Object)this).blockMaterial) && !(block instanceof BlockFenceGate) ? (block.blockMaterial.isOpaque() && block.renderAsNormalBlock() ? block.blockMaterial != Material.gourd : false) : true;
	}
}
