...
public class GuiShulkerBox extends GuiContainer {
	...
	private TileEntityShulkerBox.ShulkerBoxType type;
	
	public GuiShulkerBox(IInventory playerInventory, IInventory chestInventory) {
		super(new ContainerChestGeneric(playerInventory, chestInventory, ((TileEntityShulkerBox)chestInventory).getRowSize(), ((TileEntityShulkerBox)chestInventory).getSizeInventory() != 27));
