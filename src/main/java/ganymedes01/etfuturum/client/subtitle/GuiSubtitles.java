...
public class GuiSubtitles extends Gui {
    ...
    private String smartTranslation(String key) {
        ...
        if(matcher.matches()) {
            ...
            String mobKey = "subtitle.etfuturum.mob." + soundType;
        ...
        if(matcher.matches()) {
            return StatCollector.translateToLocal("subtitle.etfuturum.fall." + matcher.group(1));
        }
        return null;
    }
    ...
    private String getSubtitleText(ISound sound, String name) {
        ...
        if(name.startsWith("step."))
            name = "footsteps";
        String key = "subtitle.etfuturum." + name;
