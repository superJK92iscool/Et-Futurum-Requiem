	...
	public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
		...
		if (stack.stackSize == 0) {
			...
			if (placeBlockAt(stack, player, world, x, y, z, side, p_77648_8_, p_77648_9_, p_77648_10_, j1, bamboo)) {
				world.playSoundEffect((float) x + 0.5F, (float) y + 0.5F, (float) z + 0.5F, bamboo.stepSound.func_150496_b()/*getPlaceSound*/, (bamboo.stepSound.getVolume() + 1.0F) / 2.0F, bamboo.stepSound.getPitch() * 0.8F);
				--stack.stackSize;
