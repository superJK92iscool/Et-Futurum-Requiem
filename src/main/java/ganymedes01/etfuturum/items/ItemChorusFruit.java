...
public class ItemChorusFruit extends ItemFood implements IConfigurable {
	...
	private static boolean teleportTo(EntityLivingBase entity, double xx, double yy, double zz) {
		...
		entity.worldObj.playSoundEffect(d3, d4, d5, Reference.MCv119 + ":item.chorus_fruit.teleport", 1.0F, 1.0F);
		entity.playSound(Reference.MCv119 + ":item.chorus_fruit.teleport", 1.0F, 1.0F);
		return true;
	}
