...
public class VersionChecker extends Thread {
	...
	private static final List<String> downloadURLs = new LinkedList<String>();
			...
			if (
				...
				if (!instance.isLatestVersion()) {
					...
					String text = String.format(StatCollector.translateToLocal("gui.chat.update"),
							EnumChatFormatting.AQUA.toString() + EnumChatFormatting.ITALIC + Reference.MOD_NAME + EnumChatFormatting.RESET,
							EnumChatFormatting.YELLOW + latestVersion + EnumChatFormatting.RESET);
