...
public class ConfigModCompat extends ConfigBase {
	...
	protected void syncConfigOptions() {
		...
		moddedRawOres = getBoolean("moddedRawOres", catMisc, true, "Raw ores for modded metals. Includes the following items, including blocks for them: "
		...
		moddedDeepslateOres = getBoolean("moddedDeepslateOres", catMisc, true, "Deepslate ores for modded ores. Includes the following blocks: "
