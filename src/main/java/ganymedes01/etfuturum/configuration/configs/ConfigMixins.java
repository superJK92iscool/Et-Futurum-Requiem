...
public class ConfigMixins extends ConfigBase {
	...
	public static boolean enableNewCreativeFlightSpeed;
	...
	protected void syncConfigOptions() {
		...
		enableNewCreativeFlightSpeed = cfg.getBoolean("enableNewCreativeFlightSpeed", catBackport, true, "Backport the boosted creative flight speed when sprinting in newer versions");
