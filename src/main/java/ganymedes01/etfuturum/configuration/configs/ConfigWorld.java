...
public class ConfigWorld extends ConfigBase {
	...
	protected void syncConfigOptions() {
		...
		enableBambooWorldgen = getBoolean("spawnBamboo", catGeneration, true, "Whether bamboo should naturally spawn in the overworld. Turning this off allows you to use bamboo based blocks without bamboo world gen for mod compatability.");
