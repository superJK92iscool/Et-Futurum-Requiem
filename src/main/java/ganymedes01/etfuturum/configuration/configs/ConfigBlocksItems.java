...
public class ConfigBlocksItems extends ConfigBase {
	...
	protected void syncConfigOptions() {
		...
		deepslateHardness = getFloat("deepslateHardness", catBlockNatural, 2.333333333f, 0.0f, 100.0f, "Set how hard deepslate is and it's derivatives, in case you like the look of deepslate but don't want to deal with the additional hardness. To match stone, set to 1.");
