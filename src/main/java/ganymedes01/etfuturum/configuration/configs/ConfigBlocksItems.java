...
public class ConfigBlocksItems extends ConfigBase {
	...
	protected void syncConfigOptions() {
		...
		deepslateHardness = getFloat("deepslateHardness", catBlockNatural, 3.0, 0.0, 100.0, "Set how hard deepslate is, in case you like the look of deepslate but don't want to deal with the additional hardness. Regular stone is 1.5.");
