		...
		for (int i = 0; i < 6; i++) {//TODO: Make this less complicated, I should just register these individually or make a more readable iterator...
			...
			for (int i = 0; i <= 7; i++) {//TODO: Maybe make this not a loop as well like the other ones I put a TODO on, although this loop adds a ton of recipes
				...
				if (OreDictionary.doesOreNameExist("materialWax") || OreDictionary.doesOreNameExist("materialWaxcomb") ||
					...
					addShapelessRecipe(new ItemStack(ModBlocks.COPPER_BLOCK.get(), 1, i + 8), "itemBeeswax", ModBlocks.COPPER_BLOCK.newItemStack(1, i));
					addShapelessRecipe(new ItemStack(ModBlocks.COPPER_BLOCK.get(), 1, i + 8), "materialWax", ModBlocks.COPPER_BLOCK.newItemStack(1, i));
					addShapelessRecipe(new ItemStack(ModBlocks.COPPER_BLOCK.get(), 1, i + 8), "materialWaxcomb", ModBlocks.COPPER_BLOCK.newItemStack(1, i));
					addShapelessRecipe(new ItemStack(ModBlocks.COPPER_BLOCK.get(), 1, i + 8), "materialHoneycomb", ModBlocks.COPPER_BLOCK.newItemStack(1, i));
					if (i > 3) {
						addShapelessRecipe(ModBlocks.CUT_COPPER_SLAB.newItemStack(1, i), "itemBeeswax", new ItemStack(ModBlocks.CUT_COPPER_SLAB.get(), 1, i - 4));
						addShapelessRecipe(ModBlocks.CUT_COPPER_SLAB.newItemStack(1, i), "materialWax", new ItemStack(ModBlocks.CUT_COPPER_SLAB.get(), 1, i - 4));
						addShapelessRecipe(ModBlocks.CUT_COPPER_SLAB.newItemStack(1, i), "materialWaxcomb", new ItemStack(ModBlocks.CUT_COPPER_SLAB.get(), 1, i - 4));
						addShapelessRecipe(ModBlocks.CUT_COPPER_SLAB.newItemStack(1, i), "materialHoneycomb", new ItemStack(ModBlocks.CUT_COPPER_SLAB.get(), 1, i - 4));
						addShapelessRecipe(new ItemStack(copper_stairs[i], 1), "itemBeeswax", new ItemStack(copper_stairs[i - 4], 1));
						addShapelessRecipe(new ItemStack(copper_stairs[i], 1), "materialWax", new ItemStack(copper_stairs[i - 4], 1));
						addShapelessRecipe(new ItemStack(copper_stairs[i], 1), "materialWaxcomb", new ItemStack(copper_stairs[i - 4], 1));
						addShapelessRecipe(new ItemStack(copper_stairs[i], 1), "materialHoneycomb", new ItemStack(copper_stairs[i - 4], 1));
					}
				} else {
					addShapelessRecipe(new ItemStack(ModBlocks.COPPER_BLOCK.get(), 1, i + 8), "slimeball", ModBlocks.COPPER_BLOCK.newItemStack(1, i));
					if (i > 3) {
						addShapelessRecipe(ModBlocks.CUT_COPPER_SLAB.newItemStack(1, i), "slimeball", new ItemStack(copper_stairs[i], 1, i - 4));
						addShapelessRecipe(new ItemStack(copper_stairs[i], 1), "slimeball", new ItemStack(copper_stairs[i - 4], 1));
					}
				}
			}
