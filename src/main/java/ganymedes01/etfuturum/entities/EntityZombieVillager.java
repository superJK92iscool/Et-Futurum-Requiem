...
public class EntityZombieVillager extends EntityZombie {
	...
	{
		return Reference.MCv119 + ":entity.zombie_villager.ambient";
	}

	protected String getHurtSound()
	{
		return Reference.MCv119 + ":entity.zombie_villager.hurt";
	}

	protected String getDeathSound()
	{
		return Reference.MCv119 + ":entity.zombie_villager.death";
	}

	protected void func_145780_a(int p_145780_1_, int p_145780_2_, int p_145780_3_, Block p_145780_4_)
	{
		this.playSound(Reference.MCv119 + ":entity.zombie_villager.step", 0.15F, 1.0F);
	}
