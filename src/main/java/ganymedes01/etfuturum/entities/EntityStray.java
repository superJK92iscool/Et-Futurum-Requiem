...
public class EntityStray extends EntitySkeleton {
	...
	protected String getLivingSound() {
		return Reference.MCv119 + ":entity.stray.ambient";
	}
	
	@Override
	protected String getHurtSound() {
		return Reference.MCv119 + ":entity.stray.hurt";
	}
	
	@Override
	protected String getDeathSound() {
		return Reference.MCv119 + ":entity.stray.death";
	}
	
	@Override
	protected void func_145780_a(final int p_145780_1_, final int p_145780_2_, final int p_145780_3_, final Block p_145780_4_) {
		this.playSound(Reference.MCv119 + ":entity.stray.step", 0.15f, 1.0f);
	}
