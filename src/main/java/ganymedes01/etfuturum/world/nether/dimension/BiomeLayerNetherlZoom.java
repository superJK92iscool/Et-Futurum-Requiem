...
public class BiomeLayerNetherlZoom extends BiomeLayerNether {
	public BiomeLayerNetherlZoom(long par1, BiomeLayerNether par3GenLayer) {
		super(par1);
	...
	public static BiomeLayerNether magnify(long par0, BiomeLayerNether par2GenLayer, int par3) {
		Object object = par2GenLayer;

		for (int k = 0; k < par3; ++k) {
			object = new BiomeLayerNetherlZoom(par0 + k, (BiomeLayerNether) object);
		}

		return (BiomeLayerNether) object;
	}
}