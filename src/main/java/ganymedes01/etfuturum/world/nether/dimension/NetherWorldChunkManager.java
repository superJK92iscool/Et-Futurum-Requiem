...
public class NetherWorldChunkManager extends WorldChunkManager {
	...
	public NetherWorldChunkManager(long par1, WorldType par3WorldType) {
		this();
		GenLayer[] var4 = BiomeLayerNether.initializeAllBiomeGenerators(par1, par3WorldType, 1);
		genBiomes = var4[0];
		biomeIndexLayer = var4[1];
	}

	public NetherWorldChunkManager(World par1World) {
